...
public class Task03 {
    public static void main(String[] args) {
        ...
        if (healthPointPercentage > 0 && healthPointPercentage < 25) System.out.println("RED");
        if (healthPointPercentage > 25 && healthPointPercentage < 50) System.out.println("ORANGE");
        if (healthPointPercentage > 50 && healthPointPercentage < 75) System.out.println("YELLOW");
        if (healthPointPercentage <= 100) System.out.println("GREEN");
        return null;
    }
}